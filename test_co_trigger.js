...
// Test cases
const testCases = [
  { msg: 'co',                    shouldMatch: true,  reason: 'simple "co"' },
  { msg: 'Co',                    shouldMatch: true,  reason: 'capital C' },
  { msg: 'CO',                    shouldMatch: true,  reason: 'all caps' },
  { msg: 'cO',                    shouldMatch: true,  reason: 'mixed case' },
  { msg: 'co partner',            shouldMatch: true,  reason: 'at start' },
  { msg: 'find co',               shouldMatch: true,  reason: 'in middle' },
  { msg: 'hey co!',               shouldMatch: true,  reason: 'with punctuation' },
  { msg: 'co\n',                  shouldMatch: true,  reason: 'with newline' },
  { msg: ' co ',                  shouldMatch: true,  reason: 'with spaces' },
  { msg: 'co-op',                 shouldMatch: false, reason: 'hyphenated (should NOT match)' },
  { msg: 'coco',                  shouldMatch: false, reason: 'part of word' },
  { msg: 'acomb',                 shouldMatch: false, reason: 'embedded' },
  { msg: 'Partner found',         shouldMatch: false, reason: 'no "co" present' },
  { msg: '__Partner found__ 😺',  shouldMatch: false, reason: 'original message' },
  { msg: 'cooper',                shouldMatch: false, reason: 'starts with "co" but continues' },
  { msg: 'acorn',                 shouldMatch: false, reason: 'contains "co" inside' },
];
